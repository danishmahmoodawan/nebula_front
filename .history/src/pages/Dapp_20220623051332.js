...
const Dapp = () => {
  return (
    ...
    <section class="tabs-section text-white">
         <div class="container">
            <div class="row">
               <div class="col-sm-5 col-lg-3 col_side">
                  <ul class="nav nav-tabs flex-column mb-3">
                     <li class="nav-item">
                        <a class="nav-link active show" data-toggle="tab" href="#tab-1">Dashboard</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-2">Nodes</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-3">NFTs</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-4">Swap</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab-5">Bridge</a>
                     </li>
                  </ul>
               </div>
