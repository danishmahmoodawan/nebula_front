   ...
   <div className="container-fluid bg-nav">
	...
	<div className="container  nebula_sec">
		<div className="row">
            ...
            <p className="para_p  ">The Overseer <br/>
  ...
  Liquidity pool and itself to ensure a smooth price bound token.
	...
	<div className="container  nebula_sec">
		<div className="row">
            ...
            <p className="para_p  ">-To purchase our token head over to our in house swap located at <br/> http://swap.nebfi.io/ and purchase 10 NeFi tokens then goto our DApp to get your ticket to be a Nebulan!v
