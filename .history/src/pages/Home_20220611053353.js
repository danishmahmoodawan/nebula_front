   ...
   <div className="container-fluid bg-nav">
	...
	<div className="container nebula_sec">
		<div className="row">
            ...
            <p className="para_p p_ad pos_a">Nebula is not just another node protocol, we are striving to <br/> have utility not just with our nodes, but by creating an entire ecosystem you can write home about!
            </p>
